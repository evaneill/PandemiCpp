...
Experiments::K3_50k_AStar_CurePrecondition_UCTMaxChildExperiment::K3_50k_AStar_CurePrecondition_UCTMaxChildExperiment(){
    // Hard-code a description for this experiment
    experiment_name = "K3_50k_AStar_CurePrecondition_UCTMaxChildExperiment";
    ...
    fileheader = "K3_50k_AStar_CurePrecondition_UCTMaxChildExperiment";// .header ,.csv
...
void Experiments::K3_50k_AStar_CurePrecondition_UCTMaxChildExperiment::write_header(){
...
void Experiments::K3_50k_AStar_CurePrecondition_UCTMaxChildExperiment::reset_board(Board::Board* game_board){
    scenario -> reset_board(game_board);
}

void Experiments::K3_50k_AStar_CurePrecondition_UCTMaxChildExperiment::append_header(std::string extras){
    std::ofstream header(Experiments::OUTPUT_DIR + fileheader+".header",std::ios::out | std::ios::app);
    header << extras;
    header.close();
}

void Experiments::K3_50k_AStar_CurePrecondition_UCTMaxChildExperiment::write_experiment(std::string data){
    std::ofstream logfile(Experiments::OUTPUT_DIR + fileheader + ".csv",std::ios::out | std::ios::trunc);
    logfile << data;
    logfile.close();
}

Board::Board* Experiments::K3_50k_AStar_CurePrecondition_UCTMaxChildExperiment::get_board(){
    return scenario -> make_board({1,2,3},4);
}

Agents::BaseAgent* Experiments::K3_50k_AStar_CurePrecondition_UCTMaxChildExperiment::get_agent(GameLogic::Game* game){
...
int main(){
    Experiments::Experiment* experiment = new Experiments::K3_50k_AStar_CurePrecondition_UCTMaxChildExperiment();
