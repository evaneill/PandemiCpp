...
namespace Agents
{
    class KSampleSubGoalHeuristicUCTMaxChildAgent: public BaseAgent{
    ...
    public:
        ...
        KSampleSubGoalHeuristicUCTMaxChildAgent(GameLogic::Game& _active_game,int n_simulations,int K,int VisitConvergenceCriteria=100);
        ~KSampleSubGoalHeuristicUCTMaxChildAgent(){
            if(search_tree){
                delete search_tree;
            }
        };
