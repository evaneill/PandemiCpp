...
Actions::Action* Agents::KSample_Subgoal_UCTMaxChildAgent::generate_action(bool verbose){
...
Search::Node* Agents::KSample_Subgoal_UCTMaxChildAgent::get_max_child(Search::Node* root){
...
double Agents::KSample_Subgoal_UCTMaxChildAgent::get_max_avgreward(Search::Node* node){
    if(node -> terminal){
...
void Agents::KSample_Subgoal_UCTMaxChildAgent::take_step(bool verbose){
...
void Agents::KSample_Subgoal_UCTMaxChildAgent::reset(){
    tree_depths.clear();
...
std::vector<std::string> Agents::KSample_Subgoal_UCTMaxChildAgent::get_keys(){
    return {
        "AvgTreeDepth",
        "StdTreeDepth",
        "MaxTreeDepth",
...
std::vector<double> Agents::KSample_Subgoal_UCTMaxChildAgent::get_values(){
    // Avg tree depth
    double depth_mean=0;
