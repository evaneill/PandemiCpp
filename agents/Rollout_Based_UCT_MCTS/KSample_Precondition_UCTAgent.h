...
namespace Agents
{
    class KSample_Precondition_UCTAgent: public BaseAgent{
    ...
    public:
        ...
        KSample_Precondition_UCTAgent(GameLogic::Game& _active_game,int n_simulations,int K);
        ~KSample_Precondition_UCTAgent(){
            if(search_tree){
                delete search_tree;
            }
        };
