...
namespace Agents
{
    class KSample_Naive_UCTMaxChildAgent: public BaseAgent{
    ...
    public:
        ...
        KSample_Naive_UCTMaxChildAgent(GameLogic::Game& _active_game,int n_simulations,int K,int VisitConvergenceCriteria=100);
        ~KSample_Naive_UCTMaxChildAgent(){
            if(search_tree){
                delete search_tree;
            }
        };
