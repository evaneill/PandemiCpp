...
#include "KSampleNaiveUCTMaxChildAgent.h"

#include "search_tools/Search.h"

Agents::KSampleNaiveUCTMaxChildAgent::KSampleNaiveUCTMaxChildAgent(GameLogic::Game& _active_game, int _n_simulations, int _K,int _VisitConvergenceCriteria):
...
Actions::Action* Agents::KSampleNaiveUCTMaxChildAgent::generate_action(bool verbose){
...
double Agents::KSampleNaiveUCTMaxChildAgent::get_max_avgreward(Search::Node* node){
    if(node -> terminal){
...
void Agents::KSampleNaiveUCTMaxChildAgent::take_step(bool verbose){
...
void Agents::KSampleNaiveUCTMaxChildAgent::reset(){
    tree_depths.clear();
...
std::vector<std::string> Agents::KSampleNaiveUCTMaxChildAgent::get_keys(){
    return {
        "AvgTreeDepth",
        "StdTreeDepth",
        "MaxTreeDepth",
...
std::vector<double> Agents::KSampleNaiveUCTMaxChildAgent::get_values(){
    // Avg tree depth
    double depth_mean=0;
