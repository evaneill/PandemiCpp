...
#include "KSampleAStarCompoundHeuristicUCTMaxChildAgent.h"

#include "search_tools/Search.h"

Agents::KSampleAStarCompoundHeuristicUCTMaxChildAgent::KSampleAStarCompoundHeuristicUCTMaxChildAgent(GameLogic::Game& _active_game, int _n_simulations, int _K,int _VisitConvergenceCriteria):
...
Actions::Action* Agents::KSampleAStarCompoundHeuristicUCTMaxChildAgent::generate_action(bool verbose){
...
Search::Node* Agents::KSampleAStarCompoundHeuristicUCTMaxChildAgent::get_max_child(Search::Node* root){
...
double Agents::KSampleAStarCompoundHeuristicUCTMaxChildAgent::get_max_avgreward(Search::Node* node){
    if(node -> terminal){
...
void Agents::KSampleAStarCompoundHeuristicUCTMaxChildAgent::take_step(bool verbose){
...
void Agents::KSampleAStarCompoundHeuristicUCTMaxChildAgent::reset(){
    tree_depths.clear();
...
std::vector<std::string> Agents::KSampleAStarCompoundHeuristicUCTMaxChildAgent::get_keys(){
    return {
        "AvgTreeDepth",
        "StdTreeDepth",
        "MaxTreeDepth",
...
std::vector<double> Agents::KSampleAStarCompoundHeuristicUCTMaxChildAgent::get_values(){
    // Avg tree depth
    double depth_mean=0;
