...
void Agents::KSampleNaiveUCTAgent::reset(){
    tree_depths.clear();
...
std::vector<std::string> Agents::KSampleNaiveUCTAgent::get_keys(){
    return {
        "AvgTreeDepth",
        "StdTreeDepth",
        "MaxTreeDepth",
...
std::vector<double> Agents::KSampleNaiveUCTAgent::get_values(){
    // Avg tree depth
    double depth_mean=0;
