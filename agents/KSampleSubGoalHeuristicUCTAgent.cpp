...
#include "KSampleSubGoalHeuristicUCTAgent.h"

#include "search_tools/Search.h"

Agents::KSampleSubGoalHeuristicUCTAgent::KSampleSubGoalHeuristicUCTAgent(GameLogic::Game& _active_game, int _n_simulations, int _K):
