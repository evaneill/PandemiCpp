...
namespace Agents
{
    class KSampleGoalHeuristicUCTMaxChildAgent: public BaseAgent{
    ...
    public:
        ...
        KSampleGoalHeuristicUCTMaxChildAgent(GameLogic::Game& _active_game,int n_simulations,int K,int VisitConvergenceCriteria=100);
        ~KSampleGoalHeuristicUCTMaxChildAgent(){
            if(search_tree){
                delete search_tree;
            }
        };
