...
namespace Agents
{
    class KSampleNaiveUCTMaxChildAgent: public BaseAgent{
    ...
    public:
        ...
        KSampleNaiveUCTMaxChildAgent(GameLogic::Game& _active_game,int n_simulations,int K,int VisitConvergenceCriteria=100);
        ~KSampleNaiveUCTMaxChildAgent(){
            if(search_tree){
                delete search_tree;
            }
        };
