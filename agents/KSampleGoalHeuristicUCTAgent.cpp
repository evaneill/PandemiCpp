...
void Agents::KSampleGoalHeuristicUCTAgent::reset(){
    tree_depths.clear();
...
std::vector<std::string> Agents::KSampleGoalHeuristicUCTAgent::get_keys(){
    return {
        "AvgTreeDepth",
        "StdTreeDepth",
        "MaxTreeDepth",
...
std::vector<double> Agents::KSampleGoalHeuristicUCTAgent::get_values(){
    // Avg tree depth
    double depth_mean=0;
