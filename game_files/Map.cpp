...
Map::City::City(int ind, int pop, int col, std::string _name,std::set<int> neighbors):
	index(ind),
	population(pop),
	color(col),
	name(_name),
...
// I feel like this should return a reference to the city, not a new instantiation of the same city.
